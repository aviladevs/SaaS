...
class CSPMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request, response):
        ...
        csp = (
            "default-src 'sel'; "
            "script-src 'sel' 'unsafe-inline' 'unsafe-eval' *.googleapis.com *.gstatic.com; "
            "style-src 'sel' 'unsafe-inline' *.googleapis.com *.gstatic.com; "
            "img-src 'sel' data: *.googleapis.com *.gstatic.com; "
            "font-src 'sel' *.googleapis.com *.gstatic.com; "
            "connect-src 'sel' *.googleapis.com; "
