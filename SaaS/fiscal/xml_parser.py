        ...
        try:
            ...
            if emit is not None:
                ...
                if ender_emit is not None:
                    ...
                    emit_data['u'] = self.get_text(ender_emit, 'UF')
            ...
            if dest is not None:
                ...
                if ender_dest is not None:
                    ...
                    dest_data['u'] = self.get_text(ender_dest, 'UF')
            ...
            return {
                'chave_acesso': chave,
                'numero_n': numero.text if numero is not None else None,
        ...
        try:
            ...
            if rem is not None:
                ...
                if ender_rem is not None:
                    ...
                    rem_data['u'] = self.get_text(ender_rem, 'UF')
